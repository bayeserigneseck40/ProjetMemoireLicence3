...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="images/favicon/favicon-32x32.png" sizes="16x16">
  <!-- Favicons-->
    ...
    <div class="col s12 z-depth-4 card-panel">
      <form class="formValidate" id="formValidate" method="post" action="" novalidate="novalidate" class="col s12">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input name="email" id="email" type="email"  data-error=".errorTxt1">
      ...
      <div class="errorTxt1"></div>     
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input name="prenom" id="prenom" type="text"  data-error=".errorTxt1">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            <i class="mdi-social-person-outline prefix"></i>
            <input name="nom" id="nom" type="text" data-error=".errorTxt2">
      ...
      <div class="errorTxt4"></div>     
        ...
        <div class="row margin">
          ...
          <div class="input-field col s12">
            <i class="mdi mdi-home "></i>
            <input name="role" id="role" type="text" data-error=".errorTxt4">
            <label for="adres">Role</label>
		     	<div class="errorTxt4"></div>			
          </div>
        </div>		
        <div class="row">
          <div class="input-field col s12">
			<a href="javascript:void(0);" onclick="document.getElementById('formValidate').submit();" class="btn waves-effect waves-light col s12">s'inscrire</a>
          </div>
          <div class="input-field col s12">
            <p class="margin center medium-small sign-up">Vous avez déja un compte? <a href="connexion.php">se connecter</a></p>
          </div>
        </div>
      </form>
    </div>
