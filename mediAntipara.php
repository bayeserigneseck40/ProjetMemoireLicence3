...
<div id="contenu">
  ...
  <div class="container" id="container">
        ...
        <nav class="navbar navbar-expand-sm bg-white navbar-white">
            ...
            <input class="form-control mr-sm-2" id="cat" name="cat" type="hidden" value="Antiparasitaires">
  ...
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <a class="navbar-brand" href="#"><i class="fal fa-briefcase-medicalt"></i>&nbsp;&nbsp;Nos Medicaments</a>
  ...
  <div class="container">
    ...
    <div class="row mt-2 pb-3">
      ...
      $id=$_SESSION['ph'];
              ...
              $sql="SELECT* FROM (medicaments join categorie on id_categorie=num_categorie)  join stock on medicaments.id_medicament=stock.id_medicament where nom_categorie='Antiparasitaires' and stock.num_pharmacie=$id order by nom";
