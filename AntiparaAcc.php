      ...
      <?php
           if(isset($_SESSION['ph'])){
            $num=$_SESSION['ph'];
              ...
              $sql="SELECT* FROM (medicaments join categorie on id_categorie=num_categorie)  join stock on medicaments.id_medicament=stock.id_medicament where nom_categorie='Antiparasitaires' and stock.num_pharmacie=$num order by nom limit 4";
        ...
        <div class="card-deck">
          ...
          <td><a href='detailsCommande.php?code=<?php echo $numero ?>'><img src="<?= $im?>" class="card-img-top" height="250"></a>
            <div class="card-body p-1">
              ...
              <h5 class="card-text text-center text-danger"><i class="fad fa-sack"></i></i>&nbsp;&nbsp;<?= number_format($row['prix'],2) ?>fcfa</h5>
