...
<div id="contenu">
  ...
  <div class="container" id="container">
        ...
        <nav class="navbar navbar-expand-sm bg-white navbar-white">
            ...
            <input class="form-control mr-sm-2" name="cat" id="cat" type="hidden" value="Douleur et Fievre">
  ...
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link active" href="AnnulerCommande.php"><i class="fal fa-briefcase-medical mr-2"></i>Commandes en cours</a>
        </li>
        <!-- <li class="nav-item">
  ...
  <div class="container">
    ...
    <div class="row mt-2 pb-3">
      ...
      $id=$_SESSION['ph'];
              ...
              $sql="SELECT* FROM (medicaments join categorie on id_categorie=num_categorie)  join stock on medicaments.id_medicament=stock.id_medicament where nom_categorie='Douleur et Fievre' and stock.num_pharmacie=$id order by nom";
