      ...
      <form class="formValidate" id="formValidate" method="post" action="" novalidate="novalidate" class="col s12">
        <div class="row">
          <div class="input-field col s12 center">
            <h4 style="color: SeaGreen;">Recuperer votre mot de passe!</h4>
      ...
      <div class="errorTxt1"></div>     
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input name="mdp" id="mdp" type="password" required  data-error=".errorTxt1">
            <label for="prenom" class="center-align"> mot de passe</label>
