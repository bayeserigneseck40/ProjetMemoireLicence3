...
if(isset($_GET['code'])){
    ...
    $stmt->execute();
       if($row=$stmt->fetch()){
        ...
        //     $reqim="SELECT url from image where id_medicament=$voir ";
        ...
        //   }
           ...
           echo" <div class='container'>";
               ...
               echo"<div class='row gy-4'>";
                 ...
                 echo"<div class='portfolio-details-slider swiper-container'>";
    ...
    <!-- ======= Portfolio Details Section ======= -->
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>medicament information</h3>
              <ul>
                <li><strong>Category</strong>:Douleur et Fievre</li>
                <li><strong>Posologie</strong>: ASU Company</li>
                <li><strong>date fabrication</strong>: 01 March, 2020</li>
