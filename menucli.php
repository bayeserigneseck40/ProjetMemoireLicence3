      ...
      <div class="header-container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li id="submit"><a class="nav-link scrollto" href="searchgardeph.php">Pharmacies de Gardes</a></li>
            <li><a class="nav-link scrollto" href="historiques.php">Historique</a></li>
