      ...
      <?php
        ...
        if(isset($_SESSION['ph'])){
          $num=$_SESSION['ph'];
              ...
              $sql="SELECT* FROM (medicaments join categorie on id_categorie=num_categorie)  join stock on medicaments.id_medicament=stock.id_medicament where nom_categorie='Trouble digestif' and stock.num_pharmacie=$num  order by nom limit 4";
