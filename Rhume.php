...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-sm bg-white navbar-white">
            ...
            <section class="sec1">
                <center>
                <h4><a href="Rhume.php">Categorie de medicaments pour la Rhume et l'Etat grippal</a><h4>  
    </center>
                
                      <?php
        // include 'includes/header.php';
        include 'connect_BD.php';
        $sql="SELECT* FROM (medicaments join categorie on id_categorie=num_categorie) natural join stock where nom_categorie='Rhume et Etat grippal' order by nom";
                ...
                <div  class="inline">
                  ...
                  <div  class="row text-center">
                   <div class="col-md-3 col-sm-6"> 
                        <div  class="thumbnail">  
                        <td><a href='detailsmedoc.php?code=<?php echo $numero ?>'><img src="<?php echo $im?>" alt="Responsive image"></a>
                          <div  class="caption">
                              <h3><?php echo $nom ?></h3>
                              <p><?php echo $prix?></p>
                               <?php  echo "\t" ?>       
