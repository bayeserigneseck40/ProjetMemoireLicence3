...
include "connect_BD.php";
    if(isset($_GET['code'])){
        $code=$_GET['code'];
        $sql="select * from pharmacies where num_pharmacie=$code";
        $res=$connect->query($sql);
        if($res){
            $ligne=$res->fetch();
            $numero=$ligne['num_gerant'];
            $req="select * from personnes where id_personne=$numero";
            ...
            <div class="col-md-10 mt-5 pt-5">
                <div class="row 2-depth-3" id="container">
                    ...
                    <div class="col-sm-8 bg-white rounded-right" >
                        <h3 class="mt-3 text-center">Information Pharmacie</h3>
                        <hr class="badge-primarty mt-0 w-25">
                        <div class="col-sm-6">
                            <p class="font-weight-bold">Ville:</p>
                            <h6 class="text-muted"><?php echo $ligne['ville'] ;?></h6>
                        </div>
                        <div class="col-sm-6">
                            <p class="font-weight-bold">Adresse:</p>
                            <h6 class="text-muted"><?php echo $ligne['adresse'] ;?></h6>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <h6 class="text-muted"><?php echo $ligne['description'] ;?></h6>
                        </div>
                        <div class="col-sm-6">
                            <p class="font-weight-bold">Pharmacien:</p>
                            <h6 class="text-muted">Dr <?php echo $row['nom'] ;?></h6>
                        </div>
                    </div>
