...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-sm bg-white navbar-white">
            ...
            <section class="sec1">
                <center>
                <h4><a href="Douleur.php">Categorie de medicaments pour la Fatigue</a><h4>  
    </center>
                
                      <?php
        // include 'includes/header.php';
        include 'connect_BD.php';
        $sql="SELECT* FROM (medicaments join categorie on id_categorie=num_categorie) natural join stock where nom_categorie='Fatigue' order by nom";
