...
<div id="contenu">
  ...
  <div class="container mt-4 shadow-lg">
   ...
   $num=$_SESSION['ph'];
              ...
              $sql="SELECT* FROM (medicaments join categorie on id_categorie=num_categorie) join stock on medicaments.id_medicament=stock.id_medicament where nom_categorie='Fatigue' and stock.num_pharmacie=$num  order by nom limit 4";
          ...
          <td><a href='detailsCommande.php?code=<?php echo $numero ?>'><img src="<?= $im?>" class="card-img-top" height="250"></a>
            ...
            <div class="card-footer p-1">
              <form action="" class="form-submit">
                ...
                <button class="btn btn-info btn-block addItemBtn" id="addItemBtn"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;<h3>Ajouter au panier
          </h3> </button>
              </form>
            </div>
          </div>
