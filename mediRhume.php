...
<div id="contenu">
  ...
  <div class="container" id="container">
        ...
        <nav class="navbar navbar-expand-sm bg-white navbar-white">
            ...
            <input class="form-control mr-sm-2" id="cat" name="cat" type="hidden" value="Rhume et Etat grippal">
  ...
  <div class="container">
    ...
    <div class="row mt-2 pb-3">
      ...
      $id=$_SESSION['ph'];
              ...
              $sql="SELECT* FROM (medicaments join categorie on id_categorie=num_categorie)  join stock on medicaments.id_medicament=stock.id_medicament where nom_categorie='Rhume et Etat grippal' and stock.num_pharmacie=$id order by nom";
